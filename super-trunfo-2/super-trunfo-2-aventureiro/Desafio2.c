...
int main(){
    ...
    if(atributo == 1){
        ...
        strcpy(nomeAtributo, "Nº de Pontos Turísticos");
    }
    else if(atributo == 5){
    ...
    switch(atributo){
        ...
        case 2: // Área
            printf("Área da carta 1 (%s): %.2f\n", nomeCidade1, area1);
            printf("Área da carta 2 (%s): %.2f\n", nomeCidade2, area2);
        ...
        case 3: // PIB
            ...
            else if(pib1 == pib2) printf("Empate!!!\n");
            else printf("Carta 2 Venceu !!!\n");
        break;

        case 4: // Número de pontos turísticos
            printf("Pontos turísticos da carta 1 (%s): %d\n", nomeCidade1, pontosT1);
            printf("Pontos turísticos da carta 2 (%s): %d\n", nomeCidade2, pontosT2);
            if(pontosT1 > pontosT2) printf("Carta 1 Venceu !!!\n");
            else if(pontosT1 == pontosT2) printf("Empate!!!\n");
            else printf("Carta 2 Venceu !!!\n");
        break;

        case 5: // Densidade demográfica (menor vence)
            printf("Densidade demográfica da carta 1 (%s): %.2f hab/Km²\n", nomeCidade1, densidadePopulacional1);
            printf("Densidade demográfica da carta 2 (%s): %.2f hab/Km²\n", nomeCidade2, densidadePopulacional2);
            if(densidadePopulacional1 < densidadePopulacional2) printf("Carta 1 Venceu !!!\n");
            else if(densidadePopulacional1 == densidadePopulacional2) printf("Empate!!!\n");
            else printf("Carta 2 Venceu !!!\n");
        break;
    }
